...
\cite{sha3} can be used to eliminate bias.  Similarly, Barak et. al. propose a technique whereby random numbers are pulled from several independent
...
al. propose another technique where random numbers are multiplied by a Toeplitz matrix to approach a uniform distribution \cite{toeplitz}.  These
