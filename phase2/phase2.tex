...
ability to produce considerable entropy even at $5\,^{\circ}\mathrm{C}$ and with the camera guard closed. However there were also some vulnerabilities, an attacker could
